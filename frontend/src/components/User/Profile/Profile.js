...
import { userProfileAction ,followUserAction ,unfollowUserAction} from "../../../redux/slices/users/userSlices";
...
export default function Profile() {
 ...
 const dispatch = useDispatch();
  ...
  const {
    ...
    const isLoginUser = users?.userAuth?.id === users?.profile?._id;
                             ...
                             {!isLoginUser &&  <div>
                              ...
                              <>
                                <Link
                                  ...
                                  className="inline-flex justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-yellow-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                                >
                                  <UserIcon
                                    className="-ml-1 mr-2 h-5 w-5 text-gray-400"
                                    aria-hidden="true"
                    ...
                    <div className="flex justify-center place-items-start flex-wrap  md:mb-0">
                      <div className="w-full md:w-1/3 px-4 mb-4 md:mb-0">
                        ...
                        <ul className="">
                          ...
                          <h1>No Viewer</h1> : profile?.viewedBy?.map(user => (
                            <li >
                              <Link>
